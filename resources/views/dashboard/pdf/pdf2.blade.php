    ...
    <div class="container my-5"> 
        <div style="border-bottom: 2px solid #333; padding-bottom: 20px; margin-bottom: 30px;">
            <div style="text-align: center; margin-bottom: 10px;">
                <h1 style="font-size: 32px; color: #ff13b8ff; font-weight: bold;">{{$finalReport->insurance_com_name}}</h1>
        ...
        <h3 style="color: #075728ce; font-weight: bold;">Customer Information</h3>
        </div>
        ...
        @if ($hasData)
            <div class="card-header bg-success text-white text-center">
                <h3 style="color: #075728ce; font-weight: bold;">Garage Information</h3>
            </div>
...
@endphp
        ...
        <h3 style="color: #075728ce; font-weight: bold;">Garage Uploaded Files</h3>
        </div>
        <div class="card-body">
        <div class="row">
        @foreach ($validQuestions as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #075728ce; font-weight: bold;">Spot Information</h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #075728ce; font-weight: bold;">Spot Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_2 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #075728ce; font-weight: bold;">Driver Information </h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #075728ce; font-weight: bold;">Driver Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_3 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #075728ce; font-weight: bold;">Owner Information </h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #075728ce; font-weight: bold;">Owner Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_4 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #075728ce; font-weight: bold;">Accident Person Information </h3>
    </div>
    <div class="card-body">
...
@endphp
        ...
        <div class="card mb-4">
        <div class="card-header bg-info text-white text-center">
        <h3 style="color: #075728ce; font-weight: bold;">Accident Data Uploaded Files</h3>
        </div>
        <div class="card-body">
        <div class="row">
        @foreach ($validQuestions_5 as $question)
        ...
        <h3 style="color: #075728ce; font-weight: bold;">Executive Information</h3>
        </div>
...
<div style="border: 1px solid #ccc; padding: 12px 15px; border-radius: 8px; margin-bottom: 12px; background-color: #f9f9f9;">
  ...
  Accident Representing Executive
    ...
    <span style="font-size: 16px; color: #19191aff; display: inline-block;">
        ...
        <div class="card mb-4">
        <div class="card-header bg-success text-white">
        <h4 style="color: #075728ce; font-weight: bold;">Submission Date</h4>

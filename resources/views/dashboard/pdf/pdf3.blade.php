    ...
    <div class="container my-5"> 
        <div style="border-bottom: 2px solid #333; padding-bottom: 20px; margin-bottom: 30px;">
            <div style="text-align: center; margin-bottom: 10px;">
                <h1 style="font-size: 32px; color: #6200ffff; font-weight: bold;">{{$finalReport->insurance_com_name}}</h1>
        ...
        <h3 style="color: #0fefffff; font-weight: bold;">Customer Information</h3>
        </div>
            ...
            <div class="custom-table-container">
                ...
                <th style="font-weight: normal;">{{ $finalReport->customer_name ?? 'N/A' }}</th>
                <th style="border-color: #4b0082;  /* Dark Indigo */
                color: #000000ff;             /* White text */
                padding: 14px 18px;
                text-align: left;
                ...
                <th style="font-weight: normal;">{{ $finalReport->customer_father_name ?? 'N/A' }}</th>
                </tr>
                </thead>
                ...
                <td style="font-weight: normal;">{{ $finalReport->customer_phone ?? 'N/A' }}</td>
                <td style="border-color: #4b0082;  /* Dark Indigo */
                color: #000000ff;             /* White text */
                padding: 14px 18px;
                text-align: left;
                ...
                <td style="font-weight: normal;">{{ $finalReport->customer_emergancy_contact_no ?? 'N/A' }}</td>
                </tr>
                <tr>
                <td style="border-color: #4b0082;  /* Dark Indigo */
                color: #000000ff;             /* White text */
                ...
                <td style="font-weight: normal;">{{ $finalReport->customer_email ?? 'N/A' }}</td>
                <td style="border-color: #4b0082;  /* Dark Indigo */
                color: #000000ff;             /* White text */
                padding: 14px 18px;
                text-align: left;
                ...
                <td style="font-weight: normal;">{{ $finalReport->customer_present_address ?? 'N/A' }}</td>
                </tr>
                <tr>
                <td style="border-color: #4b0082;  /* Dark Indigo */
                color: #000000ff;             /* White text */
                ...
                <td style="font-weight: normal;">{{ $finalReport->customer_premanent_address ?? 'N/A' }}</td>
                ...
                <td style="font-weight: normal;">{{ $finalReport->customer_policy_no ?? 'N/A' }}</td>
                </tr>
                ...
                <td style="font-weight: normal;">{{ $finalReport->crime_number ?? 'N/A' }}</td>
                <td style="border-color: #4b0082;  /* Dark Indigo */
                color: #000000ff;             /* White text */
                padding: 14px 18px;
                text-align: left;
                ...
                <td style="font-weight: normal;">{{ $finalReport->police_station ?? 'N/A' }}</td>
                </tr>
                <tr>
                <td style="border-color: #4b0082;  /* Dark Indigo */
                color: #000000ff;             /* White text */
                ...
                <td style="font-weight: normal;">{{ $finalReport->customer_insurance_type ?? 'N/A' }}</td>
                <td style="border-color: #4b0082;  /* Dark Indigo */
                color: #000000ff;             /* White text */
                padding: 14px 18px;
                text-align: left;
        ...
        @if ($hasData)
            <div class="card-header bg-success text-white text-center">
                <h3 style="color: #0fefffff; font-weight: bold;">Garage Information</h3>
            </div>
...
@endphp
        ...
        <h3 style="color: #0fefffff; font-weight: bold;">Garage Uploaded Files</h3>
        </div>
        <div class="card-body">
        <div class="row">
        @foreach ($validQuestions as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #0fefffff; font-weight: bold;">Spot Information</h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #0fefffff; font-weight: bold;">Spot Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_2 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #0fefffff; font-weight: bold;">Driver Information </h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #0fefffff; font-weight: bold;">Driver Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_3 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #0fefffff; font-weight: bold;">Owner Information </h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #0fefffff; font-weight: bold;">Owner Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_4 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #0fefffff; font-weight: bold;">Accident Person Information </h3>
    </div>
    <div class="card-body">
...
@endphp
        ...
        <div class="card mb-4">
        <div class="card-header bg-info text-white text-center">
        <h3 style="color: #0fefffff; font-weight: bold;">Accident Data Uploaded Files</h3>
        </div>
        <div class="card-body">
        <div class="row">
        @foreach ($validQuestions_5 as $question)
        ...
        <h3 style="color: #0fefffff; font-weight: bold;">Executive Information</h3>
        </div>
    ...
    <span style="font-size: 16px; color: #050508ff; display: inline-block;">
...
<div style="border: 1px solid #ccc; padding: 12px 15px; border-radius: 8px; margin-bottom: 12px; background-color: #f9f9f9;">
  ...
  Accident Representing Executive
    ...
    <span style="font-size: 16px; color: #050508ff; display: inline-block;">
        ...
        <div class="card mb-4">
        <div class="card-header bg-success text-white">
        <h4 style="color: #0fefffff; font-weight: bold;">Submission Date</h4>

...
<body>
   ...
   <style>
        ...
        .custom-th {
        background-color: #ff00ddce; /* Bootstrap primary */
        color: white;
        font-weight: bold;
...
.qa-label {
    ...
    <div class="container my-5"> 
        <div style="border-bottom: 2px solid #333; padding-bottom: 20px; margin-bottom: 30px;">
            <div style="text-align: center; margin-bottom: 10px;">
                <h1 style="font-size: 32px; color: #5900ffff; font-weight: bold;">{{$finalReport->insurance_com_name}}</h1>
        ...
        <h3 style="color: #ff00ddce; font-weight: bold;">Customer Information</h3>
        </div>
        ...
        @if ($hasData)
            <div class="card-header bg-success text-white text-center">
                <h3 style="color: #ff00ddce; font-weight: bold;">Garage Information</h3>
            </div>
    ...
    <td style="padding: 10px; border: 1px solid #ccc; font-weight: bold; color: #2C3E50;">
    {{ $question->question_text ?? ucfirst(str_replace('_', ' ', $column)) }}
    </td>
    <td style="padding: 10px; border: 1px solid #ccc; color: #19191a;">
    {{ $decodedAnswer }}
    </td>
    </tr>
    </tbody>
...
@endphp
        ...
        <h3 style="color: #ff00ddce; font-weight: bold;">Garage Uploaded Files</h3>
        </div>
        <div class="card-body">
        <div class="row">
        @foreach ($validQuestions as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #ff00ddce; font-weight: bold;">Spot Information</h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #ff00ddce; font-weight: bold;">Spot Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_2 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #ff00ddce; font-weight: bold;">Driver Information </h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #ff00ddce; font-weight: bold;">Driver Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_3 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #ff00ddce; font-weight: bold;">Owner Information </h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #ff00ddce; font-weight: bold;">Owner Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_4 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #ff00ddce; font-weight: bold;">Accident Person Information </h3>
    </div>
    <div class="card-body">
    ...
    @foreach ($validQuestions_4 as $question)
        ...
        <div class="card mb-4">
        <div class="card-header bg-info text-white text-center">
        <h3 style="color: #ff00ddce; font-weight: bold;">Accident Data Uploaded Files</h3>
        </div>
        <div class="card-body">
        <div class="row">
        @foreach ($validQuestions_5 as $question)
        ...
        <h3 style="color: #ff00ddce; font-weight: bold;">Executive Information</h3>
        </div>
...
<div style="border: 1px solid #ccc; padding: 12px 15px; border-radius: 8px; margin-bottom: 12px; background-color: #f9f9f9;">
  ...
  Accident Representing Executive
    ...
    <span style="font-size: 16px; color: #000000ff; display: inline-block;">
        ...
        <div class="card mb-4">
        <div class="card-header bg-success text-white">
        <h4 style="color: #ff00ddce; font-weight: bold;">Submission Date</h4>

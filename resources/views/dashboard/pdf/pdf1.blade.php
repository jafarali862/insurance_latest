...
<body>
   ...
   <thead>
    <tr>
        <th style="width: 5%; text-align: center; background-color: #007bff; color: white;">#</th>
        <th style="width: 30%; background-color: #007bff; color: white;">Description</th>
        <th style="width: 65%; background-color: #007bff; color: white;">Details</th>
    </tr>
</thead>
        ...
        @foreach ($validQuestions as $question)
            ...
            @if (!is_null($decodedAnswer) && trim($decodedAnswer) !== '' && !in_array($ext, $fileExtensions))
                <tr>
                    ...
                    <th>{{ $question->question_text ?? ucfirst(str_replace('_', ' ', $column)) }}</th>
                    <td style="color: #19191aff;">{{ $decodedAnswer }}</td>
                </tr>
            @endif
        @endforeach
    </tbody>
        ...
        @foreach ($validQuestions_2 as $question)
            ...
            @if (!is_null($decodedAnswer) && trim($decodedAnswer) !== '' && !in_array($ext, $fileExtensions))
                <tr>
                    ...
                    <td style="color: #19191aff; vertical-align: middle;">
                        {{ $decodedAnswer }}
                    </td>
                </tr>
            @endif

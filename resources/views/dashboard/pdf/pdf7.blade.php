...
<style>
/* === Variant 4: Vertical Layout with Left Labels === */
.qa-row-vertical {
    display: flex;
    ...
    <div class="container my-5"> 
        <div style="border-bottom: 2px solid #333; padding-bottom: 20px; margin-bottom: 30px;">
            <div style="text-align: center; margin-bottom: 10px;">
                <h1 style="font-size: 32px; color: #73ff73ff; font-weight: bold;">{{$finalReport->insurance_com_name}}</h1>
                <p style="font-size: 18px; color: #000000ff;">{{$finalReport->insurance_com_email}}</p>
                <p style="font-size: 18px; color: #000000ff;">{{$finalReport->insurance_com_address}}</p>
                <p style="font-size: 18px; color: #000000ff;">{{$finalReport->insurance_com_contact_person}}</p>
                <p style="font-size: 18px; color: #000000ff;">{{$finalReport->insurance_com_phone}}</p>
            </div>
        </div>
        ...
        <h3 style="color: #1878b8ff; font-weight: bold;">Customer Information</h3>
        </div>
        ...
        @if ($hasData)
            <div class="card-header bg-success text-white text-center">
                <h3 style="color: #1878b8ff; font-weight: bold;">Garage Information</h3>
            </div>
            ...
            <!-- <div style="border: 1px solid #ccc; padding: 12px 15px; border-radius: 8px; 
                        margin-bottom: 12px; background-color: #f9f9f9; 
                        display: flex; gap: 15px; align-items: center;
                        flex-wrap: wrap;">

            <span style="font-size: 16px; color: #2C3E50; font-weight: bold; min-width: 200px;flex-shrink: 0;">
            {{ $rowId++ }}. {{ $question->question_text ?? ucfirst(str_replace('_', ' ', $column)) }}
            </span>
            <span style="font-size: 16px; color: #19191a; flex: 1 1 auto;word-break: break-word;">
            {{ $decodedAnswer }}
            </span>
            </div> -->
        ...
        <div style="border: 1px solid #ddd; border-left: 5px solid #46b4f3ff; background-color: #fff; padding: 15px 20px; border-radius: 6px; margin-bottom: 15px;">
        ...
        {{ $decodedAnswer }}
           ...
           <!-- <div class="qa-row-vertical">
    <div class="qa-question-4">
        <span class="qa-label">Question:</span> 
        {{ $question->question_text ?? ucfirst(str_replace('_', ' ', $column)) }}
    </div>
    <div class="qa-answer-4">
...
@endphp
        ...
        <h3 style="color: #1878b8ff; font-weight: bold;">Garage Uploaded Files</h3>
        </div>
        <div class="card-body">
        <div class="row">
        @foreach ($validQuestions as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #1878b8ff; font-weight: bold;">Spot Information</h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #1878b8ff; font-weight: bold;">Spot Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_2 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #1878b8ff; font-weight: bold;">Driver Information </h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #1878b8ff; font-weight: bold;">Driver Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_3 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #1878b8ff; font-weight: bold;">Owner Information </h3>
    </div>
    <div class="card-body">
...
<div class="card mb-4">
    <div class="card-header bg-info text-white text-center">
        <h3 style="color: #1878b8ff; font-weight: bold;">Owner Uploaded Files</h3>
    </div>
    <div class="card-body">
        <div class="row">
            @foreach ($validQuestions_4 as $question)
...
<div class="card mb-4">
    <div class="card-header bg-success text-white text-center">
        <h3 style="color: #1878b8ff; font-weight: bold;">Accident Person Information </h3>
    </div>
    <div class="card-body">
...
@endphp
        ...
        <div class="card mb-4">
        <div class="card-header bg-info text-white text-center">
        <h3 style="color: #1878b8ff; font-weight: bold;">Accident Data Uploaded Files</h3>
        </div>
        <div class="card-body">
        <div class="row">
        @foreach ($validQuestions_5 as $question)
        ...
        <h3 style="color: #1878b8ff; font-weight: bold;">Executive Information</h3>
        </div>
    ...
    <span style="font-size: 16px; color: #000000ff; display: inline-block;">
 ...
 <div style="border: 1px solid #ccc; padding: 12px 15px; border-radius: 8px; margin-bottom: 12px; background-color: #f9f9f9;">
    ...
    <span style="font-size: 16px; color: #000000ff; display: inline-block;">
        {{ $finalReport->garage_executive ?? 'N/A' }}
    </span>
</div>
...
<div style="border: 1px solid #ccc; padding: 12px 15px; border-radius: 8px; margin-bottom: 12px; background-color: #f9f9f9;">
    ...
    <span style="font-size: 16px; color: #000000ff; display: inline-block;">
        {{ $finalReport->spot_executive ?? 'N/A' }}
    </span>
</div>
...
<div style="border: 1px solid #ccc; padding: 12px 15px; border-radius: 8px; margin-bottom: 12px; background-color: #f9f9f9;">
   ...
   Meeting Representing Executive
    ...
    <span style="font-size: 16px; color: #000000ff; display: inline-block;">
        {{ $finalReport->owner_executive ?? 'N/A' }}
    </span>
</div>
...
<div style="border: 1px solid #ccc; padding: 12px 15px; border-radius: 8px; margin-bottom: 12px; background-color: #f9f9f9;">
  ...
  Accident Representing Executive
    ...
    <span style="font-size: 16px; color: #000000ff; display: inline-block;">
        {{ $finalReport->accident_executive ?? 'N/A' }}
    </span>
</div>
        ...
        <div class="card mb-4">
        <div class="card-header bg-success text-white">
        <h4 style="color: #1878b8ff; font-weight: bold;">Submission Date</h4>

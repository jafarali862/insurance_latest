...
@section('content')
    ...
    <a href="{{ route('password.reset.request') }}" class="btn btn-primary">
    Show Pending All Request <i class="fas fa-list-ul"></i>
    </a>
    </div>

    <div class="card card-primary card-outline shadow-sm">
    <div class="card-header">
    <h3 class="card-title" style="font-size: 32px;">Password Reset List</h3>
    </div>
